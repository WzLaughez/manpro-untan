...
import { approveSeminar } from "@/lib/actions/teacherSeminar";
  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-sm bg-surface rounded-2xl shadow-xl p-6 border border-primary/30"
      >
        ...
        <div className="flex gap-3">
          ...
          <form action={approveSeminar} className="flex-1">
